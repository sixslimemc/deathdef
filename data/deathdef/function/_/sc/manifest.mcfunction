...
data modify storage slimecore:in manifest.pack set value "deathdef"
data modify storage slimecore:in manifest.version set value {major:1, minor:0, patch:0}
data modify storage slimecore:in manifest.display.name set value "Deathdef Interface"
...
data modify storage slimecore:in manifest.abstract set value true
